...
class DynamoDbDeletionTargetTest {
  ...
  fun optionalAttrsDefaultToNull() {
    ...
    assertEquals(DynamoDbTestConstants.TEST_PARTITION_KEY_NAME, partitionKeyDeletionTarget.partitionKeyName, "partitionKeyName should match")
    assertEquals(DynamoDbTestConstants.TEST_PARTITION_KEY_NAME, partitionKeyDeletionTarget.deletionKeySchema.primaryKeyName, "deletionKeySchema.primaryKeyName should match")
